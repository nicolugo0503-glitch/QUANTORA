...
(function () {
  ...
  var NAV = [
    ...
    { label: 'Desk', items: [['Your Dashboard', '/dashboard.html'], ['Backtester', '/backtest.html'], ['Options Builder', '/options.html'], ['Portfolio', '/portfolio.html'], ['Watchlist', '/watchlist.html'], ['Alerts', '/alerts.html'], ['Risk Center', '/risk.html']] },
