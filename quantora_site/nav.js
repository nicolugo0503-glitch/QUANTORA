...
var ccss = document.createElement('link'); ccss.rel='stylesheet'; ccss.href='/cinematic.css?v=6'; (document.head || document.documentElement).appendChild(ccss);
var cij = document.createElement('script'); cij.src='/cinematic.js?v=6'; cij.async=true; (document.head || document.documentElement).appendChild(cij);
...
{ label: 'Markets', items: [['Market Map', '/map.html'], ['Markets tape', '/markets.html'], ['Live Crypto Stream', '/stream.html'], ['Live stream', '/live.html'], ['Coins', '/coins.html'], ['Crypto Markets', '/crypto.html'], ['Stocks', '/stocks.html'], ['Global FX & Commodities', '/global.html'], ['Chart', '/chart.html'], ['Heatmap', '/heatmap.html'], ['Screener', '/screener.html']] },
{ label: 'On-Chain', items: [['On-Chain Dashboard', '/tvl.html'], ['DeFi', '/defi.html'], ['Bitcoin Chain', '/chain.html'], ['DEX', '/dex.html'], ['Perps · Funding', '/funding.html'], ['Token Unlocks', '/unlocks.html'], ['Staking', '/staking.html'], ['Layer 2s', '/l2.html'], ['Wallet', '/wallet.html'], ['Signals', '/signals.html']] },
{ label: 'Research', items: [['SEC Filings', '/edgar.html'], ['SEC Financials', '/financials.html'], ['Compare Financials', '/fincompare.html'], ['Insider Trades', '/insider.html'], ['Superinvestors 13F', '/superinvestors.html'], ['Trending Tickers', '/watching.html'], ['Congressional Trades', '/congress.html'], ['Analyst Ratings', '/ratings.html'], ['Earnings Calendar', '/earnings.html'], ['Explain a Move', '/explain.html'], ['Research Report', '/report.html'], ['Rates & Curves', '/rates.html'], ['Recession Odds', '/recession.html'], ['Macro Dashboard', '/economy.html'], ['Bond Ladder', '/bondladder.html'], ['Credit Risk', '/credit.html'], ['News', '/news.html'], ['Global Events', '/events.html'], ['Predictions', '/predictions.html'], ['Macro', '/macro.html'], ['Calendar', '/calendar.html'], ['Fundamentals', '/fundamentals.html'], ['AI Analyst', '/analyst.html'], ['Ask Quantora', '/ask.html']] },
{ label: 'Desk', items: [['Your Dashboard', '/dashboard.html'], ['Backtester', '/backtest.html'], ['Options Builder', '/options.html'], ['Expected Move', '/cone.html'], ['Exotic Options', '/exotics.html'], ['Futures & FX', '/futures.html'], ['Monte Carlo', '/montecarlo.html'], ['Performance Lab', '/perf.html'], ['Risk Parity', '/riskparity.html'], ['CVaR Optimizer', '/cvar.html'], ['Black-Litterman', '/blacklitterman.html'], ['Correlation Matrix', '/correlation.html'], ['Pairs Analyzer', '/pairs.html'], ['Risk-Return Map', '/riskmap.html'], ['Seasonality', '/seasonality.html'], ['Portfolio', '/portfolio.html'], ['Watchlist', '/watchlist.html'], ['Alerts', '/alerts.html'], ['Drawdown Lab', '/drawdown.html'], ['Factor Lab', '/factor-lab.html'], ['Position Sizer', '/stop-loss.html'], ['Rolling Correlation', '/rolling-correlation.html'], ['Position VaR', '/position-var.html'], ['Stock Monte Carlo', '/stock-montecarlo.html'], ['Crowd Consensus', '/crowd.html'], ['DCA Backtester', '/dca.html'], ['Sharpe Compare', '/sharpe-compare.html'], ['Rolling Sharpe', '/rolling-sharpe.html'], ['Portfolio Beta', '/portfolio-beta.html'], ['Beta Hedge', '/hedge.html'], ['Kelly Sizer', '/kelly.html'], ['52-Week Range', '/range.html'], ['Cross-Asset Corr', '/macro-correlation.html'], ['Track Record', '/track.html'], ['My Library', '/library.html'], ['Compare Stocks', '/compare.html'], ['Explore Screens', '/explore.html'], ['Embed Widgets', '/embed.html'], ['Sector Rotation', '/sector-rotation.html'], ['Trend / Reversion', '/trend.html'], ['Beta & Regime', '/beta.html'], ['Relative Strength', '/relative.html'], ['Return Distribution', '/distribution.html'], ['Risk Parity', '/riskparity.html'], ['Yield Curve', '/yield-curve.html'], ['Inflation Nowcast', '/inflation.html'], ['Cross-Asset Regime', '/cross-asset.html'], ['Portfolio Doctor', '/portfolio-doctor.html'], ['Move Explainer', '/move-explainer.html'], ['Earnings Summary', '/earnings-ai.html'], ['Volatility Lab', '/vol-lab.html'], ['Stock Risk Lab', '/stock-risk.html'], ['Risk Center', '/risk.html']] },
