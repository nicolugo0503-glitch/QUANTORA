...
(function () {
  ...
  var NAV = [
    ...
    { label: 'Research', items: [['Research Report', '/report.html'], ['Rates & Curves', '/rates.html'], ['Bond Ladder', '/bondladder.html'], ['News', '/news.html'], ['Global Events', '/events.html'], ['Predictions', '/predictions.html'], ['Macro', '/macro.html'], ['Calendar', '/calendar.html'], ['Fundamentals', '/fundamentals.html'], ['AI Analyst', '/analyst.html'], ['Ask Quantora', '/ask.html']] },
    { label: 'Desk', items: [['Your Dashboard', '/dashboard.html'], ['Backtester', '/backtest.html'], ['Options Builder', '/options.html'], ['Expected Move', '/cone.html'], ['Monte Carlo', '/montecarlo.html'], ['Performance Lab', '/perf.html'], ['Risk Parity', '/riskparity.html'], ['Portfolio', '/portfolio.html'], ['Watchlist', '/watchlist.html'], ['Alerts', '/alerts.html'], ['Risk Center', '/risk.html']] },
