...
(function () {
  ...
  var NAV = [
    ...
    { label: 'Desk', items: [['Your Dashboard', '/dashboard.html'], ['Backtester', '/backtest.html'], ['Options Builder', '/options.html'], ['Expected Move', '/cone.html'], ['Monte Carlo', '/montecarlo.html'], ['Performance Lab', '/perf.html'], ['Risk Parity', '/riskparity.html'], ['Correlation Matrix', '/correlation.html'], ['Pairs Analyzer', '/pairs.html'], ['Risk-Return Map', '/riskmap.html'], ['Portfolio', '/portfolio.html'], ['Watchlist', '/watchlist.html'], ['Alerts', '/alerts.html'], ['Risk Center', '/risk.html']] },
