...
(function () {
  ...
  var NAV = [
    ...
    { label: 'Desk', items: [['Your Dashboard', '/dashboard.html'], ['Backtester', '/backtest.html'], ['Options Builder', '/options.html'], ['Expected Move', '/cone.html'], ['Exotic Options', '/exotics.html'], ['Futures & FX', '/futures.html'], ['Monte Carlo', '/montecarlo.html'], ['Performance Lab', '/perf.html'], ['Risk Parity', '/riskparity.html'], ['CVaR Optimizer', '/cvar.html'], ['Black-Litterman', '/blacklitterman.html'], ['Correlation Matrix', '/correlation.html'], ['Pairs Analyzer', '/pairs.html'], ['Risk-Return Map', '/riskmap.html'], ['Seasonality', '/seasonality.html'], ['Portfolio', '/portfolio.html'], ['Watchlist', '/watchlist.html'], ['Alerts', '/alerts.html'], ['Volatility Lab', '/vol-lab.html'], ['Stock Risk Lab', '/stock-risk.html'], ['Risk Center', '/risk.html']] },
